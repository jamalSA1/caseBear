...
export default function Home() {
  return (
    <div className="bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tighter text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your image on a{" "}
                <span className="bg-orange-600 px-2 text-white">Custom
                </span>
                {" "}Phone Case
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                phone case. CaseBear allows you to protect your memories, not
                just phone case.
              </p>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  ...
                  <p className="text-gray-800">
                    <span className="font-semibold text-black">1.250 </span>
                    happy Customers
                  </p>
                </div>
              </div>
      ...
      {/* { value proposition section / قسم اقتراح القيمة } */}
          ...
          <div className="grid mx-auto max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Adlov Aaron</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Rafael Jonathan</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-orange-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
      ...
      <section className="">
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            ...
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
              ...
              <span className="relative px-2 bg-orange-600 text-white">your own case</span>{" "}now
            </h2>
            </div>
          </div>
        ...
        <div className="flex justify-center">
          <Link href='/configure/upload' className={buttonVariants({
            size: 'lg',
            className: 'mx-auto mt-8 hover:bg-orange-700'
          })}>
          Create your case
